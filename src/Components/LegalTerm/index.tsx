              ...
              <section>
                ...
                <div className="bg-slate-800/50 rounded-lg p-6">
                  <div className="space-y-4 text-sm text-gray-300">
                    <p>
                      <strong className="text-teal-400">1. Finalidade:</strong>{" "}
                      Este é um projeto demonstrativo fictício criado para
                      portfólio profissional. Todos os conteúdos são
                      ilustrativos.
                    </p>
                    <p>
                      <strong className="text-teal-400">2. Isenção:</strong> Não
                      associado a nenhuma liga esportiva ou serviço real.
                      Imagens/logos são para fins demonstrativos.
                    </p>
                    <p>
                      <strong className="text-teal-400">3. Privacidade:</strong>{" "}
                      Nenhum dado real é coletado. Formulários e interações são
                      simulações frontend.
                    </p>
                    <p>
                      <strong className="text-teal-400">4. Direitos:</strong>{" "}
                      Código-fonte © {new Date().getFullYear()} Maurício Ferg.
                      Projeto não-comercial.
                    </p>
                    <p>
                      <strong className="text-teal-400">5. Dados:</strong>{" "}
